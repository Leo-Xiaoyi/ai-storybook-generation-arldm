...
CLIPTokenizer_path = os.environ.get(
    "STABLE_DIFFUSION_V1_5_PATH",
    os.path.join("..", "models", "stable-diffusion-v1-5"),
)
Pretrained_link = os.environ.get("BLIP_PRETRAINED_PATH", os.path.join("..", "models", "model_large.pth"))
...
@hydra.main(config_path="../configs", config_name="oxford_arldm")
